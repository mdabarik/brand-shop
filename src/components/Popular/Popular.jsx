...
const Popular = () => {
    ...
    useEffect(() => {
        fetch("https://brand-shop-server-e61d5nzmg-mdabarik.vercel.app/products")
        .then(res => res.json())
        .then(data => {
    ...
    return (
        <div className='container mx-auto flex flex-col justify-center items-center space-y-2 my-8 w-[90%]'>
