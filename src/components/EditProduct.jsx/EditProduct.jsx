...
const EditProduct = () => {
    ...
    useEffect(() => {
        fetch(`https://brand-shop-server-e61d5nzmg-mdabarik.vercel.app/product-types`)
        .then(res => res.json())
        .then(data => {
            setProdTypes(data);
        })
    ...
    const handleFormSubmit = (e) => {
        ...
        fetch(`https://brand-shop-server-e61d5nzmg-mdabarik.vercel.app/edit/${id}`, {
            method: "PUT",
            headers: {
    ...
    return (
        <div className="">
            <div className="flex flex-col items-center justify-center py-10 space-y-2">
                ...
                <p className="text-sm pb-5 text-center w-[92%]">Provide details information to add new product.</p>
